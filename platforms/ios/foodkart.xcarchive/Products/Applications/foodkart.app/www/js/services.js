...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://shopcard-c683e.firebaseio.com/"),
    refCart = new Firebase("https://shopcard-c683e.firebaseio.com/cart"),
    refUser = new Firebase("https://shopcard-c683e.firebaseio.com/users"),
    refCategory = new Firebase("https://shopcard-c683e.firebaseio.com/category"),
    refOrder = new Firebase("https://shopcard-c683e.firebaseio.com/orders"),
    refFeatured = new Firebase("https://shopcard-c683e.firebaseio.com/featured"),
    refMenu = new Firebase("https://shopcard-c683e.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
